...
<template>
  ...
  <main class="flex-1 p-8 bg-white rounded-xl mt-6 mr-3 mb-6">
    ...
    <section class="mb-6">
      <h2 v-if="createdGroups" class="text-xl font-semibold mb-4">OWN GROUPS</h2>
      <div
      ...
      >
        <div
          class="border text-card-foreground shadow-sm bg-white rounded-2xl overflow-hidden"
          data-v0-t="card"
        >
          <img
            alt="Group"
          ...
          <div class="p-4">
            ...
            <button
              class="inline-flex items-center whitespace-nowrap text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 w-full justify-between rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 text-gray-500 dark:hover:bg-gray-700 px-4 py-3 transition-colors"
            >
              <span>View</span>
              <svg
